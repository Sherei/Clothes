...
const SingleAdd = () => {
  ...
  async function AddToCart(
    ...
    //   }
    // }
    else if (product?.category === "wardrobes") {
      if (product.color1 != undefined) {
        if (!color) {
          return setError("options");
        }
          ...
          <div className="col-lg-5 col-sm-12 order-3" style={{ position: "relative", height: "fit-content" }}>
            ...
            <div className={`s_content ${product?.category === "bed" ? "bed_class" : ""}`}>
              ...
              <div className="single_form  mt-1">
                ...
                {(product?.category != "bed" && product?.category != "sofa" && product?.category != "accesories" && product?.category != "mattress" && product?.category != "wardrobes" && product?.category != "dining-table") &&
                  <div className="mt-1">
                    <label
                ...
                {((product.category === "sofa" || product.category === "wardrobes" || product?.category === "accesories") && product.color1 !== undefined) &&
                  <div className="mt-1">
                    <label
                      style={{ fontSize: "17px", fontWeight: "600" }}
                    >
