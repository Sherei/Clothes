              ...
              <div className='row'>
                ...
                <div className='col-lg-6  col-md-6 col-sm-12  my-2'>
                  ...
                  >
                    ...
                    <option value="accesories">Home Accessories</option>
                ...
                {(selectedCategory === 'dining-table') && (
                  <div className='col-lg-6  col-md-6 col-sm-12  my-2'>
                    ...
                    >
                      <option value="select subCategory">Select subCategory</option>
                      <option value="turkish-dining-table">Turkish Dining Table</option>
                ...
                {/* Colors */}
                {(selectedCategory === "sofa" || selectedCategory === "wardrobes" || selectedCategory === "accesories") &&
                  <>
